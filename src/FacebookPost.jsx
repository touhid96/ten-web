...
const FacebookPost = ({ post }) => {
  const { userName, profilePicture, posts, followStatus } = post;
  return (
      ...
      <div className="max-w-md mx-auto bg-white rounded-md shadow-md overflow-hidden">
        ...
        <div className="p-4">
          <div className="flex justify-between items-center">
            <p className="text-gray-800 leading-relaxed">{posts[0].title}</p>

            <button className="bg-[#4B6CB7] rounded-md p-2">
              <p className="font-bold text-white">{posts[0].category}</p>
            </button>
          </div>
          ...
          <img
            ...
            alt="Post Image"
            className="mt-4 rounded-md w-full h-64 object-contain"
          />
